 ...
 */
export interface PDFBookData extends PDFBaseData {
    /**
 ...
 * @param data
 */
export function isPDFBookData(data: PDFBaseData | null | undefined): data is PDFBookData {
    return !!data && data.type === PDFDataType.Book;
}
